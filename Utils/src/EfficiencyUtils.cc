// $Id: EfficiencyUtils.cc,v 1.2 2012/05/28 14:28:29 anlevin Exp $
...
ClassImp(mithep::EfficiencyUtils)
...
TGraphAsymmErrors* EfficiencyUtils::createEfficiencyGraph(TH1F* numerator, TH1F* denominator,
                                                    string histname, 
                                                    vector<Double_t> bins, Int_t errorType = 2, 
                                                    Double_t xlow = -99, Double_t xhigh = -99, 
                                                    Double_t ylow = -99, Double_t yhigh = -99 
  ) {

  TH1F *n = PlotUtils::rebin(numerator,bins,string(numerator->GetName()) + "_rebinned_in_eff_utils");
  TH1F *d = PlotUtils::rebin(denominator,bins,string(denominator->GetName()) + "_rebinned_in_eff_utils");
